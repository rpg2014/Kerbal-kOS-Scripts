...
//
local burn_duration to nd:deltav:mag/max_acc. // TODO change this to account for changing mass, but as this is an estimate, its not important.  The main burn takes into account the mass loss.
print "Crude Estimated burn duration: " + round(burn_duration) + "s".

print "Warping to 5 seconds before beginning rotation".
warpto(time:seconds + (nd:eta - (burn_duration/2))-  65).
...
wait until vang(np, ship:facing:vector) < 0.25 or nd:eta <= (burn_duration/2).
